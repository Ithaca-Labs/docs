---
title: "Bazaar metadata and discovery"
description: "Declare, validate, catalog, browse, and search paid HTTP and MCP resources."
sidebarTitle: "Bazaar discovery"
keywords:
  - "x402 Bazaar"
  - "resource discovery"
  - "catalog metadata"
...
[`packages/bazaar-sdk/examples/weather-http.ts`](https://github.com/Ithaca-Labs/openx402/blob/main/packages/bazaar-sdk/examples/weather-http.ts);
the paid Express integration is in the [seller guide](/guides/http-seller).
...
maintain. See [MCP seller cataloging](/guides/mcp#catalog-a-paid-mcp-seller-tool) for
...
[`facilitator/docs/CATALOG-TRUST.md`](https://github.com/Ithaca-Labs/openx402/blob/main/facilitator/docs/CATALOG-TRUST.md).
...
- [HTTP seller guide](/guides/http-seller)
- [MCP catalog and agent guide](/guides/mcp)
- [Security](/operations/security)
- [Search implementation](https://github.com/Ithaca-Labs/openx402/blob/main/facilitator/docs/SEARCH.md)
