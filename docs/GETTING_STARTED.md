...
| Service | URL | Role |
| --- | --- | --- |
| Facilitator | `https://facilitator-production-8430.up.railway.app` | Verify, settle, sponsor fees, and catalog |
| Discovery MCP | `https://mcp-production-e242.up.railway.app/mcp` | Search and inspect catalog entries only |
...
> Preview status: `exact` is implemented and live on testnet with the canonical
> client. Stellar `upto` is a proposed scheme. Pubnet is disabled and is not
> production-ready.
...
## 4. Confirm automatic cataloging

From any directory:

```bash
curl -fsS \
  'https://facilitator-production-8430.up.railway.app/discovery/search?query=rock%20paper%20scissors' \
  | jq
```
...
- [Build a paid HTTP seller](SELLER_GUIDE.md)
- [Understand the canonical buyer](BUYER_CLIENT.md)
- [Declare and search Bazaar metadata](BAZAAR.md)
- [Catalog and discover paid MCP tools](MCP.md)
- [Deploy your own facilitator](SELF_HOSTING.md)
- [Troubleshoot the flow](TROUBLESHOOTING.md)
