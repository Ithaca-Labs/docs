---
title: "Pay a Stellar x402 resource"
description: "Build a safe canonical buyer for Stellar exact payment challenges."
sidebarTitle: "Buyer client"
keywords:
  - "x402 buyer"
  - "Stellar exact"
  - "payment client"
...
Source: [`examples/rock-paper-scissors/client.ts`](https://github.com/Ithaca-Labs/openx402/blob/main/examples/rock-paper-scissors/client.ts)
...
- [Build the seller](/guides/http-seller)
- [Understand Bazaar cataloging](/concepts/bazaar)
- [Use a local signer-enabled agent MCP](/guides/mcp#run-a-private-paid-agent-mcp)
