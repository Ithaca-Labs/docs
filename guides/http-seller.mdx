---
title: "Build a paid HTTP seller"
description: "Protect an Express route with Stellar exact payments and official Bazaar metadata."
sidebarTitle: "HTTP seller"
keywords:
  - "x402 seller"
  - "Express payments"
  - "Bazaar metadata"
...
[`examples/rock-paper-scissors/index.ts`](https://github.com/Ithaca-Labs/openx402/blob/main/examples/rock-paper-scissors/index.ts).
...
is [`packages/bazaar-sdk/examples/weather-http.ts`](https://github.com/Ithaca-Labs/openx402/blob/main/packages/bazaar-sdk/examples/weather-http.ts).

## Next steps

- [Run and understand the buyer client](/guides/buyer-client)
- [Understand catalog identity, trust, and discovery](/concepts/bazaar)
- [Troubleshoot repeated 402s and rejected metadata](/operations/troubleshooting)
